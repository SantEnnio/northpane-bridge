...
diff -u "$repository_root/Protocol/compatibility/bridge-v1-revision-14.proto" "$repository_root/Protocol/bridge-v1.proto"

echo "Generated Protobuf source matches revision 14; frozen revisions 1 to 13 are unchanged"
